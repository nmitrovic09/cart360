 ...
 * to the user pressing the respective buttons
 * NOTE:: the notes played are NOT stored
 * SO: you need to read in the input from the analog input (linked to the button-resistor ladder combo)
...
void fadeIn(int LED_Pin, int value)
{
  for(int i = 0; i < value; i++)
  {
    analogWrite(LED_Pin, value);   //write val to LED
    delay(20);
  }
}
